...
describe 'Test /api/users with login admin' do
  before(:all) do
    ...
    post '/api/auth/register', :params => { email: 'jonhdoe@test.com', password: '12345678', first_name: 'John', last_name: 'Doe', org_role_id: admin_role_id }
